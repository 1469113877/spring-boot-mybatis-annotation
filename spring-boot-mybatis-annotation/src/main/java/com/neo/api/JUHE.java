...
public class JUHE {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="cbdd94426b42c5bf6b5afa0ecbaba38a";
    ...
    //6.深圳股市列表
    public static JSONObject getRequest6(Integer page,Integer type){
        String result =null;
    ...
    //7.沪股列表
    public static JSONObject getRequest7(Integer page,Integer type){
        String result =null;
